        ...
        <div class="categoryContentContainer">
            ...
            <div class="contentWrapper">
                <div class="element">
                    ...
                    <img src="<?=IMAGESPATH?>19.png" alt="RaspberryPi Abbildung">
                    <p>RaspberryPi-Boards von One bis Zero</p></a>
                </div>
                <div class="element">
                    <a href="index.php?c=pages&a=subcategory&subcat=RaspberryPi&cat=Gehäuse">
                    <img src="<?=IMAGESPATH?>28.png" alt="RaspberryPi Gehäuse">

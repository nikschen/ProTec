            ...
            <form method="post" >
                <div class="addressView">
                    <div class="shippingAddress">
                        ...
                        <input class="oneLine" type="text" name="cityShipping" placeholder="Ort*" value="<?if (isset($_POST['cityShipping'])){echo $_POST['cityShipping'];}else echo $cityShippingValue?>" required ><br>
